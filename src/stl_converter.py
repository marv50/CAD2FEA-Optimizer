...
def clean_mesh(vertices, faces):
    """
    Repair and clean a surface mesh using pymeshfix to ensure it's watertight and manifold.

    This step is necessary before volumetric meshing (e.g., tetrahedralization).
    ...
    Returns:
        tuple:
            - clean_vertices (ndarray): Repaired vertex array.
            - clean_faces (ndarray): Repaired face index array.
    """
